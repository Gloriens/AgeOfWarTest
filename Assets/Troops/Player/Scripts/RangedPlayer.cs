...
public class RangedPlayer : Enemy
{
    ...
    {       
        _rigidGiant.velocity = Vector2.right * Time.deltaTime * speed *speedMlti;
    ...
    void AttackAnim()
    {
        ...
        hit = Physics2D.Raycast(raycastOrigin, Vector2.right, 0.1f);
